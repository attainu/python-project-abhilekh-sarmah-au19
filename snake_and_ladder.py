...
game_layout_display = pygame.display.set_mode(
    (width_screen, height_screen), pygame.FULLSCREEN)
...
d1 = pygame.image.load("resources/dice1.jpg")
d2 = pygame.image.load("resources/dice2.jpg")
d3 = pygame.image.load("resources/dice3.jpg")
d4 = pygame.image.load("resources/dice4.jpg")
d5 = pygame.image.load("resources/dice5.jpg")
d6 = pygame.image.load("resources/dice6.jpg")

red_c = pygame.image.load("resources/red.png")
yellow_c = pygame.image.load("resources/simple.png")
green_c = pygame.image.load("resources/green.png")
blue_c = pygame.image.load("resources/blue.png")
...
def main_menu():
    ...
    while m:
        ...
        button("Exit", mouse[0], mouse[1], (width_screen / 2 - 100), (height_screen / 2) + 200, 200, 100, red_color,
               blue_red_color, 60, 0)
...
def choice():
    ...
    while f == True:
        ...
        best1 = button("Vs Computer", mouse[0], mouse[1], (width_screen / 2 - 150), 250, 300, 50, green_color,
                       blue_green_color, 30, "s")
        # 2 player button
        best2 = button("1 vs 1", mouse[0], mouse[1], (width_screen / 2) - 150, 350, 300, 50, green_color,
                       blue_green_color, 30, 2)
        # 3 player
        best3 = button("Triple", mouse[0], mouse[1], (width_screen / 2) - 150, 450, 300, 50, green_color,
                       blue_green_color, 30, 3)
        # 4 player
        best4 = button("4 Player", mouse[0], mouse[1], (width_screen / 2) - 150, 550, 300, 50, green_color,
                       blue_green_color, 30, 4)
        # Back button
        best5 = button("Back", mouse[0], mouse[1], 0,
                       650, 200, 50, red_color, blue_red_color, 30, 5)
        if best5 == 5:
            main_menu()
        if best1 == "s":
            playing(21)
...
def playing(best):
    ...
    game_layout_display.blit(
        mother_board, (width_screen / 2 - 250, height_screen / 2 - 250))
    ...
    while True:
        ...
        if best == 21:
            ...
            button1("Computer", mouse[0], mouse[1], 400,
                    700, 200, 50, yellow_color, grey_color, 30)
            if True:
                if tips == 2:
                    ...
                    if gamer2score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen(
                                "Computer Wins", 650, 50, 50, black_color)
            ...
            if button1("Player 1", mouse[0], mouse[1], 100, 700, 200, 50, red_color, grey_color, 30):
                if tips == 1:
                    ...
                    if gamer1score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen(
                                "Player 1 Wins", 650, 50, 50, black_color)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 2", mouse[0], mouse[1], 400, 700, 200, 50, yellow_color, grey_color, 30):
                if tips == 2:
                    ...
                    if gamer2score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen(
                                "Player 2 Wins", 650, 50, 50, black_color)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 3", mouse[0], mouse[1], 700, 700, 200, 50, green_color, grey_color, 30):
                if tips == 3:
                    ...
                    if gamer3score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen(
                                "Player 3 Wins", 650, 50, 50, black_color)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 4", mouse[0], mouse[1], 1000, 700, 200, 50, blue_color, grey_color, 30):
                if tips == 4:
                    ...
                    if gamer4score == 100:
                        ...
                        while pygame.time.get_ticks() - time_clock < 2000:
                            message_display1_screen(
                                "Player 4 Wins", 650, 50, 50, black_color)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break

        best6 = button("Back", mouse[0], mouse[1], 0,
                       0, 200, 50, red_color, blue_red_color, 30, 7)
        ...
        if less:
            ...
            while pygame.time.get_ticks() - time_clock < 2000:
                message_display1_screen(
                    "There's a Ladder!", 650, 50, 35, black_color)
                pygame.display.update()
        if set:
            time_clock = pygame.time.get_ticks()
            while pygame.time.get_ticks() - time_clock < 2000:
                message_display1_screen(
                    "There's a Snake!", 650, 50, 35, black_color)
                pygame.display.update()
